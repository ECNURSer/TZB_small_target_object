...
class BaseTrainer:
    ...
    def _do_train(self):
        ...
        plot_period = int(os.getenv("YOLO_PLOT_PERIOD", "0"))
        self.periodic_plot_idx = {
            (plot_epoch - 1) * nb for plot_epoch in range(plot_period, self.epochs + 1, plot_period)
        } if plot_period > 0 else set()
        self.plot_idx.extend(self.periodic_plot_idx)
